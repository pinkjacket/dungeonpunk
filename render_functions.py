...
def render_all(con, panel, entities, player, game_map, fov_recompute, root_console, message_log, screen_width,
    ...
    panel.draw_str(1, 3, "Depth: {0}".format(game_map.dungeon_level), fg=colors.get("white"), bg=None)
    ...
    if game_state in (GameStates.SHOW_INVENTORY, GameStates.DROP_INVENTORY):
        ...
        level_up_menu(con, root_console, "You've grown stronger! Choose a stat to raise:", player, 40, screen_width,
                      screen_height)
